        ...
        <div class="col-lg-10">
            <div class="card shadow-sm border-0 rounded-4 p-4 p-md-5">
                <div class="border-bottom pb-4 mb-4">
                    <span class="badge bg-success bg-opacity-10 text-success fw-bold px-3 py-2 rounded-pill mb-2" style="color: #87CC3E !important; background-color: rgba(135, 204, 62, 0.15) !important;">Protección de Datos Personales</span>
                    <h1 class="fw-bold text-dark display-6 mb-2">Política de Privacidad y Habeas Data</h1>
                    <p class="text-muted small mb-0">Conforme a la Ley 1581 de 2012 y Decreto 1377 de 2013 de la República de Colombia</p>
                </div>
                ...
                <div class="legal-content lh-lg text-secondary" style="font-size: 0.98rem;">
                    ...
                    <p>Los datos personales (nombres, apellidos, número de documento, correo electrónico, teléfono, tipo de sangre, contacto de emergencia y dirección) serán utilizados exclusivamente para:</p>
                    <ul class="ps-3">
                    ...
                    <p>
                        Para ejercer sus derechos de Habeas Data, consultar o solicitar la eliminación de sus datos, el titular puede enviar una comunicación formal al correo de contacto: <strong>info@femtribe.com.co</strong>.
                    </p>
                </div>
